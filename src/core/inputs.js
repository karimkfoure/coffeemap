export const inputs = {
  ...
  creativeProfileSelect: document.getElementById("creativeProfileSelect"),
  applyCreativeProfileBtn: document.getElementById("applyCreativeProfileBtn"),
  resetCreativeControlsBtn: document.getElementById("resetCreativeControlsBtn"),
  labelDensityPreset: document.getElementById("labelDensityPreset"),
  accentTarget: document.getElementById("accentTarget"),
  accentStrength: document.getElementById("accentStrength"),
  inkBoost: document.getElementById("inkBoost"),
  riverBoost: document.getElementById("riverBoost"),
  featureFocus: document.getElementById("featureFocus"),
  featureFocusStrength: document.getElementById("featureFocusStrength"),
  distortRotate: document.getElementById("distortRotate"),
  distortSkewX: document.getElementById("distortSkewX"),
  distortSkewY: document.getElementById("distortSkewY"),
  distortScaleX: document.getElementById("distortScaleX"),
  distortScaleY: document.getElementById("distortScaleY"),
  paletteBgColor: document.getElementById("paletteBgColor"),
  paletteInkColor: document.getElementById("paletteInkColor"),
  paletteAccentColor: document.getElementById("paletteAccentColor"),
